...
function displayPics(){
  ...
  // The reason why the previous line threw an error is because const rando doesn't create a property on the function/object. Whereas var does, therefore the scope is limited under const. 
  console.log(viewed);
